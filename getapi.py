...
#形態素解析した結果をリストで返す
def split(sentence,appid=appid,results='ma',filter='1|2|4|5|9|10',response='ma_response,uniq_response,baseform'):
    ret=[]
    ...
    try: return [l.surface.string for l in soup.ma_result.response]
    except: return[]
